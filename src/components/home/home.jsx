...
const Home = () => {
    return (
        <div className="flex justify-between mt-40 h-screen pl-20 pr-20 ">
    
                <div className="home-div text-white flex flex-col gap-4 home-info ">
               
                    <h2 className="text-4xl font-bold first-h2">Hello, It's Me</h2>
                 
                    <h1 className="text-6xl font-bold sec-h2">Raj Pakhurde</h1>
                    <h2 className="text-4xl font-bold ">And I'm a <span className="text-skyBlue">Software Developer</span></h2>
                    <br />
                    <p className="text-xl first-h2">Passionate Software Developer with a knack for creating innovative solutions and a commitment to delivering high-quality, user-centric applications.</p>
                    <br />
            ...
            <Zoom in={true}>
                <div className="home-div flex justify-center h-fit img-info">
